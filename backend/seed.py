...
CHECKPOINTS = [
    ...
    # capacity_per_hour подобраны под §5 так, чтобы создать контраст очередей:
    # где средний поток > ёмкости — копится затор (Актау, Бейнеу, Темир-Баба),
    # где ёмкость с запасом — узел свободен (Курык, Болашак).
    ("Порт Актау", CheckpointKind.sea_port, 43.621000, 51.157000, 55, 50),
    ("Порт Курык", CheckpointKind.sea_port, 42.760000, 52.880000, 60, 30),
    ("Погранпереход «Темир-Баба»", CheckpointKind.road_border, 41.550000, 52.580000, 30, 22),
    ("Ж/д переход «Болашак»", CheckpointKind.rail_border, 41.770000, 52.950000, 40, 16),
    ("Узел Бейнеу (трасса Актау–Бейнеу)", CheckpointKind.road_hub, 45.316000, 55.197000, 45, 35),
]
