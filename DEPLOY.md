...
- переход по ссылке → «Email подтверждён», можно войти;
- вход без подтверждения → 403 «Email не подтверждён»;
- демо-аккаунты (`*@demo`, `akimat@123`) подтверждены сидом и работают всегда.